...
if __name__ == '__main__':
    ...
    parser.add_argument("--infer_list", default="psa/voc12/val_id.txt", type=str)
    ...
    for iter, (name, img) in enumerate(infer_data_loader):
        ...
        with torch.no_grad():
            ...
            #  去除了 model = 'P'   Image.fromarray(res, model="P") ==> Image.fromarray(res) 
            out = Image.fromarray(res)
            out.save( os.path.join('/data0/zhongxiang/MCT+_dual_restat/mask/', name + '.png'))
