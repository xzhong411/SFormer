...
#                 --img-list /data0/zhongxiang/MCT+/VOC2012/ImageSets/Segmentation \
#                 --data-path /data0/zhongxiang/MCT+/VOC2012 \
#                 --gen_attention_maps \
...
python evaluation.py --list voc12/train_id.txt \
                     --gt_dir /data0/zhongxiang/MCT+/VOC2012/SegmentationClass \
